...
// Busca exercícios e usuários
$conn = conectarBD();

// Busca exercícios agrupados por categoria
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Cadastrar Treino</h1>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="../../actions/treino/cadastrar.php" method="POST" class="needs-validation" novalidate>
                        <!-- Informações Básicas -->
                        <div class="row mb-4">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="exercicio-item mb-3 border-bottom pb-3">
                                        ...
                                        <div class="exercicio-detalhes mt-2" style="display: none;">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <input type="hidden" name="exercicios[]" value="<?php echo $exercicio['id']; ?>" disabled>
                                                    <label class="form-label">Séries</label>
                                                    <input type="number" class="form-control" name="series[]" 
                                                           min="1" value="3" disabled required>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">Repetições</label>
                                                    <input type="number" class="form-control" name="repeticoes[]" 
                                                           min="1" value="12" disabled required>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">Observações</label>
                                                    <input type="text" class="form-control" name="observacoes[]" disabled>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
